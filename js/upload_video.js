...
UploadVideo.prototype.uploadFile = function(file) {
  ...
  var uploader = new MediaUploader({
    ...
    onProgress: function(data) {
      ...
      var roundedPercentageComplete = Math.floor(percentageComplete);

      var percentString =
        "width :" + roundedPercentageComplete.toString() + "%";

      $(".progress-bar").attr({
        "aria-valuenow": roundedPercentageComplete,
        style: percentString
      });

      $("#percent-transferred").text(Math.floor(percentageComplete) + "%");
